...
// Products API (berdasarkan API3_productcustomer.md)
export const productsAPI = {
  ...
  // Legacy stock methods (to be used if still needed)
...
// Customers API (berdasarkan API3_productcustomer.md)
...
// Suppliers API (berdasarkan API3_productcustomer.md)
