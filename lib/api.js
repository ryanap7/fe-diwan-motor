...
export const categoriesAPI = {
  async getAll(params = {}) {
    const response = await api.get('/categories?limit=10000', { params });
    return response.data;
  },
...
export const stockAPI = {
  ...
  async getStockOverview(params = { limit: 1000 }) {
    try {
      const response = await api.get('/stocks?limit=1000', { params });
      return response.data;
    } catch (error) {
      ...
      const response = await api.get('/products?limit=1000', { params });
      return response.data;
    }
  },
