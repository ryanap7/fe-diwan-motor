...
// Categories API (menggunakan /kategori sesuai API2.md)
...
export const brandsAPI = {
  ...
  async delete(id) {
    const response = await api.post(`/brands/${id}/delete`, {});
    return response.data;
  },

  async toggleActive(id) {
    const response = await api.post(`/brands/${id}/toggle`, {});
    return response.data;
  },
};
