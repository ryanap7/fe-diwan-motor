...
const CategoryManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingCategory) {
        await axios.post(`/api/categories/${editingCategory.id}/update`, formData, { headers });
                        ...
                        <div className="flex items-center gap-3 flex-1">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              <Badge variant={child.is_active ? 'default' : 'secondary'} className={`text-xs ${child.is_active ? 'bg-green-500' : ''}`}>
            ...
            <AlertDialogDescription>
              ...
              {getChildCategories(categoryToDelete?.id).length > 0 && (
                <span className="block mt-2 text-orange-600 font-semibold">
                  ⚠️ Kategori ini memiliki sub-kategori. Sub-kategori akan menjadi kategori utama.
                </span>
              )}
